...
const McpConnectivityIllustration: React.FC<McpConnectivityIllustrationProps> = ({ className = "" }) => {
  ...
  const integrations = [
    { name: "Epic EHR", icon: "/medical-electronic-health-record-system-icon.jpg", installed: true },
    { name: "HL7 FHIR", icon: "/healthcare-data-exchange-standard-icon.jpg", installed: true },
    { name: "Lab Systems", icon: "/medical-laboratory-equipment-icon.jpg", installed: true },
    { name: "Imaging PACS", icon: "/medical-imaging-system-icon.jpg" },
    { name: "Pharmacy", icon: "/pharmacy-management-system-icon.jpg" },
    { name: "Telehealth", icon: "/telemedicine-platform-icon.jpg" },
  ]
