...
const ParallelCodingAgents: React.FC<ParallelCodingAgentsProps> = ({ className = "" }) => {
  ...
  const themeVars = {
    ...
    "--pca-text-secondary": "hsl(var(--foreground) / 0.7)", // Improved contrast by using foreground with opacity instead of muted-foreground
    ...
    >
      ...
      <div
        style={{
          ...
          background: "linear-gradient(180deg, hsl(var(--primary) / 0.02) 0%, transparent 100%)", // Reduced opacity from 0.05 to 0.02 for better contrast
